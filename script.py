...
model_PARAMS={'n_classes':n_classes,'way':way,'shape':shape,'selected_slices':selected_slices,'losses':losses}
...
Y_up,Y_down,results=train.train_and_eval(datamodule=dm,model_PARAMS=model_PARAMS,max_epochs=max_epochs,ckpt=checkpoint)
